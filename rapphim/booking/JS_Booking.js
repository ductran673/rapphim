const moviesList = [
    { movieName: "LẬT MẶT 6", price: 90000 },
    { movieName: "NHÀ BÀ NỮ", price: 90000 },
    { movieName: "NÔ LỆ CỦA QUỶ", price: 90000 },
  ];
  ...
  let currentMovieName = `LẬT MẶT 6`;
  ...
  function updatMovieName(movieName, price) {
    ...
    moviePriceEl.innerHTML = `${price} đ`;
  }
  ...
  function successModal(movieNameIn, totalPrice, successTrue) {
    ...
    popImg.src = "https://cdn-icons-png.flaticon.com/512/148/148767.png";
    ...
    successBtn.innerHTML = `TÔI BIẾT RỒI!`;
